...
def action():
        ...
        if bch =='':
                ...
                os.system("clear")
                print (logo)
                print("9536, 9559, 9621, 9005, 9198, 9935, 9936, 9559, 9621, 9651, 9695, 9794, 9956, 9793,9180, 9440, 9441, 9490, 9491, 9492, 9493, 9494")
                print("8009, 8127, 8173, 8174, 8175, 8400, 8756, 8853, 8953, 8331, 8332, 9333, 8500, 8985")
                print("7388, 7607, 7897, 7755, 7382")
                try:
                        c = raw_input(" choose code  : ")
                        k="+91"
                        idlist = ('.txt')
